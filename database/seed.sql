...
INSERT INTO bookings (user_id, table_id, booking_date, booking_time, end_time, guests, status) VALUES 
(2, 1, CURDATE(), '18:00:00', '20:00:00', 2, 'confirmed'),
(2, 2, DATE_ADD(CURDATE(), INTERVAL 1 DAY), '19:00:00', '21:00:00', 4, 'pending');

-- Insert admin user (password: admin123)
INSERT INTO users (name, email, password, role, admin_token) VALUES 
('Admin User', 'admin@cafe.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'admin', 'ADMIN2024');
...
INSERT INTO users (name, email, password, phone, user_token) VALUES 
('John Doe', 'john@example.com', '$2b$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', '555-0123', UUID());
